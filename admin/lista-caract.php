...
?>
        <tr>
            ...
            <td class="action">
                ...
                <a href="/borrar-caracteristica?delId=<?php echo ($caracteristica['id']); ?>" class="delete" onClick="return confirm('Estás seguro? Esto no se puede deshacer');"><i class="fa fa-remove"></i> Borrar</a>
            </td>
        </tr>
